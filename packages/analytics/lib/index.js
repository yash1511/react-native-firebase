...
class FirebaseAnalyticsModule extends FirebaseModule {
  ...
  logPresentOffer(object) {
    ...
    return this.logEvent(
      ...
      validateStruct(
        object,
        structs.PresentOffer,
        'firebase.analytics().logPresentOffer(*):',
      ),
    );
  }
  ...
  logPurchaseRefund(object = {}) {
    ...
    return this.logEvent(
      ...
      validateStruct(
        object,
        structs.PurchaseRefund,
        'firebase.analytics().logPurchaseRefund(*):',
      ),
    );
  }
